...
class SentenceEmbeddings:
    ...
    @staticmethod
    def extract_sentence_embeddings_from_factcheck_output_multiclass(data_dir=None):
        data_train = []
        data_test = []
                    ...
                    if multiclass_neg_exp == True:
                        if test == False and train == True:
                            if neg_data_dir.__contains__("/date/") or neg_data_dir.__contains__("true"):
                                date_data_train.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/domain/") or neg_data_dir.__contains__("true"):
                                domain_data_train.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/domainrange/") or neg_data_dir.__contains__("true"):
                                domainrange_data_train.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/mix/") or neg_data_dir.__contains__("true"):
                                mix_data_train.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/property/") or neg_data_dir.__contains__("true"):
                                property_data_train.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/random/") or neg_data_dir.__contains__("true"):
                                random_data_train.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/range/") or neg_data_dir.__contains__("true"):
                                range_data_train.append([s, p, o, correct, sentences])

                        if test == True and train == False:
                            if neg_data_dir.__contains__("/date/") or neg_data_dir.__contains__("true"):
                                date_data_test.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/domain/") or neg_data_dir.__contains__("true"):
                                domain_data_test.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/domainrange/") or neg_data_dir.__contains__("true"):
                                domainrange_data_test.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/mix/") or neg_data_dir.__contains__("true"):
                                mix_data_test.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/property/") or neg_data_dir.__contains__("true"):
                                property_data_test.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/random/") or neg_data_dir.__contains__("true"):
                                random_data_test.append([s, p, o, correct, sentences])
                            if neg_data_dir.__contains__("/range/") or neg_data_dir.__contains__("true"):
                                range_data_test.append([s, p, o, correct, sentences])
        ...
        triple_emb = model.encode(s + " " + p + " " + o)
        # ///////////////////////////////////////////////////////////////////////////////train
        for idx, (s, p, o, c, p2) in enumerate(date_data_train):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
            ...
            embeddings_textual_evedences_train_date.append(avg_embedding)

        for idx, (s, p, o, c, p2) in enumerate(domain_data_train):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        for idx, (s, p, o, c, p2) in enumerate(domainrange_data_train):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        for idx, (s, p, o, c, p2) in enumerate(mix_data_train):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
        ...
        for idx, (s, p, o, c, p2) in enumerate(property_data_train):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        for idx, (s, p, o, c, p2) in enumerate(random_data_train):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        for idx, (s, p, o, c, p2) in enumerate(range_data_train):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        for idx, (s, p, o, c, p2) in enumerate(date_data_test):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
        ...
        for idx, (s, p, o, c, p2) in enumerate(domain_data_test):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        for idx, (s, p, o, c, p2) in enumerate(domainrange_data_test):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        for idx, (s, p, o, c, p2) in enumerate(mix_data_test):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            # Sentences are encoded by calling model.encode()
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
        ...
        for idx, (s, p, o, c, p2) in enumerate(property_data_test):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            # Sentences are encoded by calling model.encode()
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
        ...
        for idx, (s, p, o, c, p2) in enumerate(random_data_test):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        for idx, (s, p, o, c, p2) in enumerate(range_data_test):
            print(s + "\t" + p + "\t" + o + "\t" + str(c) + "\t")
            p3 = p2.copy()
            for idx2, ss in enumerate(p3):
                st1 = model.encode(ss)
        ...
        # /////////////////////////////////////////////////////////////////////////////// saving part
        path = data_dir+ "wrong/train/date/"
        ...
        path = data_dir + "wrong/train/domain/"
        ...
        path = data_dir + "wrong/train/domainrange/"
        ...
        path = data_dir + "wrong/train/property/"
        ...
        path = data_dir + "wrong/train/random/"
        ...
        path = data_dir + "wrong/train/range/"
        ...
        path = data_dir + "wrong/test/domain/"
        ...
        path = data_dir + "wrong/test/domainrange/"
        ...
        path = data_dir + "wrong/test/property/"
        ...
        path = data_dir + "wrong/test/random/"
        ...
        path = data_dir + "wrong/test/range/"
