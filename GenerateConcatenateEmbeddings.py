...
class ConcatEmbeddings:
    def __init__(self, path_dataset_folder=None):
        ...
        dataset1 = Data(data_dir=path_dataset_folder)
        ...
        print(len(test_set))
        self.saveDataToCSV(train_combined_emb_set,"trainCombinedEmbeddings")
        self.saveDataToCSV(test_combined_emb_set,"testCombinedEmbeddings")

    @staticmethod
    def saveDataToCSV(combined_emb_set=None, name="trainCombinedEmbeddings"):
...
ConcatEmbeddings(path_dataset_folder)
